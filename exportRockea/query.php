...
Class Query {
	...
	public function load($value, $key)
	{
		...
		{
			throw new Exception("Method <em>$key</em> does not exists in Query Class. Check your parameters.", 1);
		}
	}
	...
	public function __call($method, $args)
	{
		...
		{
			throw new Exception("Method <em>$method</em> does not exists in Query Class. Check your parameters.", 1);
		}
	}
	...
	{
		throw new Exception("Query::exec is deprecated, please use Query::execute", 1);
		
		// Util::debug($this->query);
	}
	...
	/**
	* Excecute a custom sql statement
	* return void
	*/
